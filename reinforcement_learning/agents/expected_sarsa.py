...
class ExpectedSarsaAgent(object):
    ...
    def _expected_sarsa_control(self):
        ...
        while not episode_ended:
            ...
            self._Q[state, action] += self._alpha * (reward + (self._gamma * self._compute_expected_value(next_state)) - self._Q[state, action]) 
    ...
    # Expected Sarsa agent's use play_episode function only for tests
