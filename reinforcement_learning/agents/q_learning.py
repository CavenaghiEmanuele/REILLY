...
class QLearningAgent(object):
    ...
    __slots__ = ["_alpha", "_gamma", "_epsilon", "_Q", "_policy", "_env"]
    ...
    def _q_control(self):
        ...
        while not episode_ended:
            ...
            self._Q[state, action] += self._alpha * (reward + (self._gamma * np.max(self._Q[next_state])) - self._Q[state, action])
    ...
    # Q learning agent's use play_episode function only for tests
